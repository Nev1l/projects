	...
	<div class="col-lg-5">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<c:set var="psd" value="${psd}" />
				<c:set var="ped" value="${ped}" />
				<c:set var="asd" value="${asd}" />
						...
						<tbody>
							<tr class="form-group">
								...
								<td class="col-lg-12"><a href="#"
									onclick="sendPost('/project/project.do','${TASK.project.id}')">${TASK.project.name}</a>
								<td>
							</tr>
							<tr class="form-group">
							...
							<tr class="form-group">
								...
								<td class="col-lg-10"><c:if test="${not empty STATUS_LIST}">
										<select class="form-control m-bot20" name="status">
											<c:if test="${empty st}">
