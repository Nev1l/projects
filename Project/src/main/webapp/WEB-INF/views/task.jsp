    ...
    <c:otherwise>
      <table>
        ...
        <c:if test="${not empty ASSIGNEE}">
           <c:set var="assignee" value="${ASSIGNEE.member.employee.firstName} ${ASSIGNEE.member.employee.lastName}"/>          
        </c:if>
        <tr>
        ...
        <tr>
          ...
          <td><a href="#" onClick="sendPost('/project/project.do','${TASK.project.id}')">${TASK.project.name}</a></td>
        </tr>
        <tr>
      ...
      <div>
      	<input type="button" value="Reassignee" onClick="sendPost('/project/assignee.do','${ASSIGNEE.task.id}')"/>
      	<input type="button" value="Activity" onClick="sendPost('/project/activity.do','${ASSIGNEE.task.id}')"/>
      </div>
    </c:otherwise>
  </c:choose>
</body>
